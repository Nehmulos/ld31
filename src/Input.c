...
void Input_addKeyboardKey(struct Input* this, enum ActionId actionId, SDL_Keycode code, int axis) {
    InputHotkey* hotkey = InputHotkey_create(HOTKEY_TYPE_KEYBOARD, actionId);
    hotkey->hotkey.key.key.sym = code;
    hotkey->hotkey.key.axisValue = axis;
    Input_addHotkey(this, hotkey);
}

void Input_loadDefault_1(Input* this) {
    // move
    Input_addKeyboardKey(this, horizontal, SDLK_LEFT, -1);
    Input_addKeyboardKey(this, horizontal, SDLK_RIGHT, +1);
    Input_addKeyboardKey(this, vertical, SDLK_UP, +1);
    Input_addKeyboardKey(this, vertical, SDLK_DOWN, -1);
    // action
    Input_addKeyboardKey(this, jump, SDLK_q, 0);
    Input_addKeyboardKey(this, attackSword, SDLK_c, 0);
    Input_addKeyboardKey(this, attackBow, SDLK_x, 0);
    Input_addKeyboardKey(this, action, SDLK_e, 0);
    // editor
    Input_addKeyboardKey(this, openMenu, SDLK_ESCAPE, 0);
    Input_addKeyboardKey(this, reloadScene, SDLK_r, 0);
    Input_addKeyboardKey(this, editorPlace, SDLK_SPACE, 0);
    Input_addKeyboardKey(this, editorTerrain, SDLK_t, 0);
    Input_addKeyboardKey(this, editorObjects, SDLK_o, 0);
    Input_addKeyboardKey(this, editorToggleStartSimulation, SDLK_HOME, 0);
    Input_addKeyboardKey(this, editorStopSimulation, SDLK_END, 0);
    Input_addKeyboardKey(this, editorSave, SDLK_f, 0);
}
...
void Input_update(Input* this) {
    this->mouseState.mod = SDL_GetMouseState(&this->mouseState.x, &this->mouseState.y);
    // TODO switching between absolute and relative mouse state, once it is needed
    //SDL_GetRelativeMouseState(&this->mouseState.xDelta, &this->mouseState.yDelta);
